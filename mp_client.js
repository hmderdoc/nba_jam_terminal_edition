// mp_client.js - Multiplayer Client with Prediction & Reconciliation
// Handles client-side input, prediction, and state synchronization
    ...
    this.handleHalftimeEvent = function (data) {
        ...
        try {
            ...
            if (typeof data.redScore === "number") {
                gameState.score.red = data.redScore;
            }
            if (typeof data.blueScore === "number") {
                gameState.score.blue = data.blueScore;
            }
