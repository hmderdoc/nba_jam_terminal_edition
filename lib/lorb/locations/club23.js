...
// Load SpriteWanderer for ambient animation
var _club23SpriteWanderer = null;
try {
    load("/sbbs/xtrn/nba_jam/lib/lorb/ui/sprite-wanderer.js");
    if (typeof LORB !== "undefined" && LORB.UI && LORB.UI.SpriteWanderer) {
        _club23SpriteWanderer = LORB.UI.SpriteWanderer;
    }
} catch (e) {
    log(LOG_DEBUG, "[CLUB23] SpriteWanderer not loaded (optional): " + e);
}
        ...
        if (_club23SpriteWanderer) {
            try {
                ...
                if (artFrame) {
                    ...
                    wanderer = new _club23SpriteWanderer({
                ...
                log(LOG_DEBUG, "[CLUB23] Wanderer init failed: " + e);
                wanderer = null;
            }
        }
