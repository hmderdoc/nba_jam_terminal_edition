            ...
            try {
                ...
                if (artFrame) {
                    ...
                    if (SpriteSelectors) {
                        ...
                        log(LOG_DEBUG, "[CLUB23] SpriteWanderer: " + patronSprites.length + " sprites selected");
                        for (var si = 0; si < patronSprites.length; si++) {
                            var sp = patronSprites[si];
                            log(LOG_DEBUG, "[CLUB23]   " + si + ": skin=" + sp.skin + 
                                " nick=" + (sp.shortNick || "(none)") +
                                " jersey=" + (sp.jerseyBg || "(none)"));
                        }
                    } else {
