...
(function() {
    ...
    function placeBet(ctx) {
        ...
        var team1 = team1Names[Math.floor(Math.random() * team1Names.length)];
        var team2 = team2Names[Math.floor(Math.random() * team2Names.length)];
        
        LORB.View.line("  \1r" + team1 + "\1n  vs  \1b" + team2 + "\1n");
        LORB.View.line("");
        LORB.View.line("Your cash: \1y$" + ctx.cash + "\1n");
        LORB.View.line("");
        LORB.View.line("\1w[1]\1n Bet on \1r" + team1 + "\1n");
        LORB.View.line("\1w[2]\1n Bet on \1b" + team2 + "\1n");
        ...
        var pickedTeam = (teamChoice === "1") ? team1 : team2;
        ...
        // Try to run actual AI vs AI game
        var gameResult = null;
        
        if (typeof runExternalGame === "function" || 
            (LORB.Core.Battle && typeof LORB.Core.Battle.watchAIGame === "function")) {
            // TODO: Hook into actual AI vs AI game viewing
            // For now, simulate
            gameResult = simulateGame(team1, team2);
        } else {
            gameResult = simulateGame(team1, team2);
        }
        ...
        LORB.View.line("");
        LORB.View.line("\1r" + team1 + "\1n: " + gameResult.score1);
        LORB.View.line("\1b" + team2 + "\1n: " + gameResult.score2);
        LORB.View.line("");
        
        var winner = (gameResult.score1 > gameResult.score2) ? team1 : team2;
