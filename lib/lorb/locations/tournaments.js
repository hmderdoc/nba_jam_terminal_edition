...
(function() {
        ...
        while (true) {
            ...
            if (viewMode === VIEW_RANKINGS) {
                ...
                if (result === "leaders") {
                    ...
                    // Show playoff bracket/status UI
    ...
    function showRankingsView(ctx, players, onlinePlayers, myGlobalId, sortMode, seasonFilter, formatSeasonLabel) {
        ...
        // Footer - add season navigation
        var footerFrame = view.getZone("footer");
        if (footerFrame) {
            footerFrame.gotoxy(1, 1);
            footerFrame.putmsg("\1h\1r" + hLine + "\1n");
            footerFrame.gotoxy(1, 2);
            footerFrame.putmsg(" \1h\1w[ENTER]\1n\1c View \1h\1w[S]\1n\1c Sort \1h\1w[\x1B/\x1A]\1n\1c Season \1h\1w[2]\1n\1c Lead \1h\1w[3]\1n\1c Recs \1h\1w[P]\1n\1r PvP \1h\1w[Q]\1n\1c Back");
        }
    ...
    function showLeadersView(ctx, players, myGlobalId, statIndex, seasonFilter, formatSeasonLabel) {
        ...
        // Footer - updated keybindings: +/- for stat, arrows for season
        var footerFrame = view.getZone("footer");
        if (footerFrame) {
            footerFrame.gotoxy(1, 1);
            footerFrame.putmsg("\1h\1c" + hLine + "\1n");
            footerFrame.gotoxy(1, 2);
            footerFrame.putmsg(" \1h\1w[+/-]\1n\1c Stat \1h\1w[\x1B/\x1A]\1n\1c Season \1h\1w[1]\1n\1c Ranks \1h\1w[3]\1n\1c Recs \1h\1w[P]\1n\1r PvP \1h\1w[O]\1n\1y Play \1h\1w[Q]\1n\1c Back");
        }
        ...
        if (key === "o" || key === "O") return "playoffs";
    ...
    function showRecordsView(ctx, players, myGlobalId, statIndex, seasonFilter, formatSeasonLabel) {
        ...
        if (footerFrame) {
            ...
            footerFrame.gotoxy(1, 2);
            footerFrame.putmsg(" \1h\1w[+/-]\1n\1c Stat \1h\1w[\x1B/\x1A]\1n\1c Season \1h\1w[1]\1n\1c Ranks \1h\1w[2]\1n\1c Lead \1h\1w[P]\1n\1r PvP \1h\1w[O]\1n\1y Play \1h\1w[Q]\1n\1c Back");
        }
    ...
    function showPvpLeadersView(ctx, players, myGlobalId, statIndex) {
        ...
        if (footerFrame) {
            ...
            footerFrame.putmsg("\1h\1r" + hLine + "\1n");
            footerFrame.gotoxy(1, 2);
            footerFrame.putmsg(" \1h\1w[\x1B/\x1A]\1n\1c Stat \1h\1w[1]\1n\1c Rankings \1h\1w[2]\1n\1c Leaders \1h\1w[3]\1n\1c Records \1h\1w[O]\1n\1y Playoffs \1h\1w[Q]\1n\1c Back");
        }
