...
(function() {
     ...
     * @param {Object} networkService - Network service instance
    ...
    function getOtherOnlinePlayerCount(ctx, networkService) {
        ...
        if (!networkService || !networkService.isActive()) return 0;
        ...
        var onlinePlayers = networkService.getOnlinePlayers() || {};
        var count = 0;
    ...
    function runRichView(ctx) {
        // Network service is attached to ctx by lorb.js
        var networkService = ctx._networkService || null;
