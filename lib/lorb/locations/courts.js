        ...
        if (SpriteWanderer) {
            try {
                ...
                if (artFrame) {
                    ...
                    // Use a single zone covering the playable court area
                    // The trapezoid shape means sprites near edges might clip, but movement works
                    var walkableZones = [
                        { x: 8, y: 14, width: 24, height: 6 }  // Main court area
                    ];
