...
(function() {
    ...
    function getCityPlayersByStats(city) {
        ...
        for (var i = 0; i < team.roster.length; i++) {
            var playerKey = teamKey + "." + team.roster[i];
            ...
            try {
                ...
                if (city) {
                    ...
                    if (courtName && courtName.length > 0) {
                        ...
                        // Write text on row 2 (leaving row 1 for spacing from top)
                ...
                log(LOG_DEBUG, "[COURTS] Failed to overlay court name: " + e);
            }
        }
