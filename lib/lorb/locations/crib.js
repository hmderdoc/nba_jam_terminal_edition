...
(function() {
    ...
    var CRIB_WALKABLE_ZONE = { x: 1, y: 12, width: 24, height: 8 };
    ...
    function runBabyMamasAndKids(ctx) {
        ...
        while (true) {
            ...
            // Initialize wandering baby sprites after loading header
            if (SpriteWanderer && babies.length > 0) {
                try {
                    ...
                    if (artFrame) {
                        ...
                        if (babySprites.length > 0) {
                            wanderer = new SpriteWanderer({
                                ...
                                sprites: babySprites,
                                walkableZones: [CRIB_WALKABLE_ZONE],
                                options: {
            ...
            view.line("\1wDependent: \1r" + dependentCount + "\1n");
            if (nemesisCount > 0) {
                view.line("\1wNemesis: \1h\1k" + nemesisCount + "\1n");
            }
            ...
            var choice = view.menu(menuItems, { y: 14, onIdle: onIdleCallback });
    ...
    function runRichView(ctx) {
        ...
        while (true) {
            ...
            var menuItems = [
                ...
                { text: "\1wMy Schedule", value: "schedule", hotkey: "4" },
                { text: "\1wBaby Mamas & Kids", value: "babies", hotkey: "5" },
                { text: "\1wTraveling Companion", value: "companion", hotkey: "6" },
            ...
            var choice = view.menu(menuItems, { y: 11, onIdle: onIdleCallback });
