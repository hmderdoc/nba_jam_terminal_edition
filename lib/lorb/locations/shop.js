...
(function() {
    ...
    function runRichView(ctx) {
        while (true) {
            ...
            if (currentSneaker) {
                ...
                contentFrame.gotoxy(2, cy++);
                contentFrame.putmsg("\1kNo sneakers\1n");
            }
            ...
            var menuItems = [
                { text: "Sneakers", value: "sneakers", hotkey: "1", tooltip: ["Permanent stat boosts", "Equip anytime you own them"] },
                { text: "Drinks", value: "drinks", hotkey: "2", tooltip: ["One-time consumables", "Boost lasts until next game"] },
                { text: "Back", value: "back", hotkey: "Q", tooltip: ["Return to the mall", ""] }
            ];
    ...
    function runDrinksMenu(ctx) {
        while (true) {
            ...
            contentFrame.putmsg("\1wCash: \1h\1y$" + (ctx.cash || 0) + "\1n");
            contentFrame.gotoxy(1, cy++);
            contentFrame.putmsg("\1kBoosts last until next game\1n");
            cy++;
