...
(function() {
    ...
    function buildSneakerItems(ctx) {
        ...
        for (var id in SNEAKERS) {
            if (SNEAKERS.hasOwnProperty(id)) {
                ...
                items.push({
                    text: "\1w" + sneaker.name + statusTag,
    ...
    function runRichView(ctx) {
        ...
        while (true) {
            ...
            contentFrame.gotoxy(1, cy++);
            contentFrame.putmsg("\1h\1c You came to the right place.\"\1n");
            cy++;
            ...
            // Show currently equipped gear
            contentFrame.gotoxy(1, cy++);
            contentFrame.putmsg("\1h\1wCurrently Equipped:\1n");
            ...
            if (ctx.equipped && ctx.equipped.feet) {
                ...
                contentFrame.gotoxy(2, cy++);
                contentFrame.putmsg("\1kNo sneakers equipped\1n");
            }
