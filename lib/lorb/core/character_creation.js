...
(function() {
    ...
    function showIntro() {
        ...
        if (RichView && typeof BinLoader !== "undefined") {
            try {
                ...
                if (footerFrame) {
                    ...
                    footerFrame.putmsg("\1cHit any key and let's GO!\1n");
                }
        ...
        LORB.View.line("\1h\1wHit any key and let's GO!\1n");
        console.getkey();
    }
    ...
    function getPlayerName(defaultName) {
        ...
        if (RichView && typeof BinLoader !== "undefined") {
            try {
                ...
                if (footerFrame) {
                    footerFrame.gotoxy(2, 2);
                    footerFrame.putmsg("\1wDrop your name (or Enter for default): \1n");
                    view.render();
                }
        ...
        var name = LORB.View.prompt("Drop your name (or Enter for default): ");
        if (!name || name.trim() === "") {
            name = defaultName;
        }
    ...
    function showSummary(name, archetype, background, stats, ctx) {
        while (true) {
            ...
            LORB.View.line("\1wLookin' good! Ready to ball? (Y/N/R=Start Over)\1n");
