...
(function() {
    ...
    function show(ctx) {
        ...
        LORB.View.line("\1h\1yอออ STATS อออ\1n");
        ...
        for (var stat in statLabels) {
            if (statLabels.hasOwnProperty(stat)) {
                ...
                // Build stat bar
                var bar = "";
                for (var b = 0; b < Math.min(effective, 10); b++) bar += "\1gÛ\1n";
                for (var b = Math.min(effective, 10); b < 10; b++) bar += "\1kฐ\1n";
        ...
        // Resources
        LORB.View.line("\1h\1yอออ RESOURCES อออ\1n");
        ...
        // Record
        LORB.View.line("\1h\1yอออ RECORD อออ\1n");
        ...
        // Equipment
        LORB.View.line("\1h\1yอออ EQUIPMENT อออ\1n");
        ...
        if (archetype && archetype.special) {
            LORB.View.line("\1h\1yอออ SPECIAL อออ\1n");
