...
(function() {
    ...
    function showRichView(ctx) {
        ...
        if (headerFrame) {
            ...
            headerFrame.putmsg("\1h\1w  STATS & RECORDS: \1h\1c" + (ctx.name || ctx.nickname || ctx.userHandle || "Unknown") + "\1n");
        ...
        if (footerFrame) {
            ...
            footerFrame.putmsg("  \1h\1w[Q]\1n\1c Back\1n");
        }
    ...
    function showForPlayerRichView(player, options) {
        ...
        if (headerFrame) {
            ...
            headerFrame.putmsg("\1h\1y" + hLine + "\1n");
            headerFrame.gotoxy(1, 2);
            var headerText = "  PLAYER CARD: \1h\1c" + (player.name || "Unknown") + "\1n";
            if (player.bbsName) {
        ...
        if (footerFrame) {
            ...
            if (showGhost && showLive) {
                footerFrame.putmsg("  \1h\1y[L]\1n\1w Live Challenge   \1h\1y[C]\1n\1w Ghost Match (up to \1h\1y$" + options.maxWager + "\1n\1w)   \1h\1w[Q]\1n\1c Back\1n");
            } else if (showLive) {
                footerFrame.putmsg("  \1h\1y[L]\1n\1w Live Challenge   \1h\1w[Q]\1n\1c Back\1n");
            } else if (showGhost) {
                footerFrame.putmsg("  \1h\1y[C]\1n\1w Challenge to Ghost Match (wager up to \1h\1y$" + options.maxWager + "\1n\1w)   \1h\1w[Q]\1n\1c Back\1n");
            } else if (options.isSelf) {
                footerFrame.putmsg("  \1kThis is you!   \1h\1w[Q]\1n\1c Back\1n");
            } else {
                footerFrame.putmsg("  \1h\1w[Q]\1n\1c Back\1n");
            }
        }
