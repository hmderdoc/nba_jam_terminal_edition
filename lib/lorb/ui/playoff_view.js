...
(function() {
    ...
    function getDetailedPlayoffStatus(status, ctx, playerId) {
        ...
        result.details.push("\1cWaiting for other matches to complete...\1n");
        ...
        if (LORB.Playoffs && LORB.Playoffs.getMatchesPastSoftDeadline) {
            ...
            if (canForceSimCount > 0) {
                ...
                result.details.push("");
                result.details.push("\1h\1y⚠ " + canForceSimCount + " match" + 
                    (canForceSimCount === 1 ? " is" : "es are") + " past deadline!\1n");
