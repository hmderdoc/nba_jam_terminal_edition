...
(function() {
    ...
    function showSplash() {
        ...
        if (!artLoaded) {
            ...
            mainFrame.gotoxy(1, 14);
            mainFrame.putmsg("\1h\1k" + centerText("Press ENTER to continue, ? for help", SCREEN_WIDTH) + "\1n");
        }
    ...
    if (!this.LORB.UI) this.LORB.UI = {};
    
    this.LORB.UI.SplashScreen = {
        run: run,
