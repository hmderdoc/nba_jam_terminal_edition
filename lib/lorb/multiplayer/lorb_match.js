...
(function () {
    ...
    function lorbCharacterToPlayerDef(ctx) {
        ...
        log("lorbCharacterToPlayerDef: name=" + (ctx.name || "null") + 
            ", nickname=" + (ctx.nickname || "null") + 
            ", shortNick=" + (shortNick || "null") +
    ...
    function lorbTeammateToPlayerDef(teammate) {
        ...
        log("lorbTeammateToPlayerDef: name=" + (teammate.name || "null") +
            ", teammate.shortNick=" + (teammate.shortNick || "null") +
            ", resolved shortNick=" + (shortNick || "null") +
            ", skin=" + (teammate.skin || "null"));
    ...
    function findActiveTeammate(ctx) {
        ...
        if (ctx.activeTeammate && typeof ctx.activeTeammate === "object") {
            log("findActiveTeammate: Using pre-extracted teammate: name=" + (ctx.activeTeammate.name || "Unknown") +
                ", skin=" + (ctx.activeTeammate.skin || "null") +
                ", shortNick=" + (ctx.activeTeammate.shortNick || "null"));
            return ctx.activeTeammate;
        }
        
        // Full context path: search contacts by activeTeammate ID
        if (!ctx.contacts || !ctx.activeTeammate) {
            log("findActiveTeammate: no contacts or activeTeammate ID, ctx.activeTeammate=" + 
                (ctx.activeTeammate !== undefined ? ctx.activeTeammate : "undefined"));
            return null;
        }
    ...
    function extractTeamColors(ctx, fallbackColorName) {
        ...
        log("extractTeamColors: jerseyColor=" + (appearance.jerseyColor || "null") + 
            ", jerseyLettering=" + (appearance.jerseyLettering || "null") + 
            " -> bg=" + bgColorName + ", fg=" + fgColorName);
    ...
    function buildLorbGameConfig(challengerCtx, challengeeCtx, challenge) {
        ...
        log("buildLorbGameConfig: CHALLENGER data:");
        log("  challengerCtx.name=" + (challengerCtx ? challengerCtx.name : "null"));
        log("  challengerCtx.appearance=" + (challengerCtx && challengerCtx.appearance ? JSON.stringify(challengerCtx.appearance) : "null"));
        log("  challengerCtx.activeTeammate=" + (challengerCtx && challengerCtx.activeTeammate ? (typeof challengerCtx.activeTeammate === "object" ? JSON.stringify(challengerCtx.activeTeammate) : challengerCtx.activeTeammate) : "null"));
        
        log("buildLorbGameConfig: CHALLENGEE data:");
        log("  challengeeCtx.name=" + (challengeeCtx ? challengeeCtx.name : "null"));
        log("  challengeeCtx.appearance=" + (challengeeCtx && challengeeCtx.appearance ? JSON.stringify(challengeeCtx.appearance) : "null"));
        log("  challengeeCtx.activeTeammate=" + (challengeeCtx && challengeeCtx.activeTeammate ? (typeof challengeeCtx.activeTeammate === "object" ? JSON.stringify(challengeeCtx.activeTeammate) : challengeeCtx.activeTeammate) : "null"));
        ...
        log("buildLorbGameConfig: teamADef.players[0].skin=" + (teamADef.players[0] ? teamADef.players[0].skin : "null") +
            ", teamADef.players[1].skin=" + (teamADef.players[1] ? teamADef.players[1].skin : "null"));
        log("buildLorbGameConfig: teamBDef.players[0].skin=" + (teamBDef.players[0] ? teamBDef.players[0].skin : "null") +
            ", teamBDef.players[1].skin=" + (teamBDef.players[1] ? teamBDef.players[1].skin : "null"));
        ...
        var gameTime = (challenge && challenge.meta && typeof challenge.meta.gameTime === "number") 
            ...
            : 120;
        log("buildLorbGameConfig: gameTime=" + gameTime + " (from " + 
            (challenge && challenge.meta && challenge.meta.gameTime ? "challenge.meta" : "default") + ")");
        ...
        log("buildLorbGameConfig: challengerHydratedCrew=" + challengerHydratedCrew.length + 
            ", challengeeHydratedCrew=" + challengeeHydratedCrew.length);
