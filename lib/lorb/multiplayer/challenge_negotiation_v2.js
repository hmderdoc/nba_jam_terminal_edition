...
(function () {
     ...
     */
    function ChallengeUI(ctx, opponent, isChallenger) {
        this.ctx = ctx;
    ...
    ChallengeUI.prototype.draw = function() {
        ...
        // Header
        var title = this.isChallenger ? "CHALLENGE: " + (this.opponent.name || "OPPONENT").toUpperCase() : "INCOMING CHALLENGE";
    ...
    ChallengeUI.prototype.runChallengerFlow = function() {
        ...
        this.challenge = Challenges.sendChallenge(this.ctx, this.opponent, { mode: "live" }, { cash: cashWager, rep: repWager });
    ...
    function showChallengerWagerInput(ctx, opponent) {
        var ui = new ChallengeUI(ctx, opponent, true);
