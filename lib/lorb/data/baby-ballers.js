...
(function() {
    ...
    function removeFromWorldRegistry(babyId) {
        ...
        try {
            ...
            log(LOG_WARNING, "[BABY-BALLERS] Failed to remove from world registry: " + e);
        }
        return false;
    }
    ...
    function addPendingEarnings(babyId, winnings, isPaidOff) {
        ...
        try {
            ...
            if (!baby) {
                log(LOG_WARNING, "[BABY-BALLERS] Baby " + babyId + " not found in world registry");
                return false;
            }
            ...
            log(LOG_WARNING, "[BABY-BALLERS] Failed to add pending earnings: " + e);
            return false;
        }
    }
    ...
    function collectPendingEarnings(ctx) {
        ...
        try {
            ...
            log(LOG_WARNING, "[BABY-BALLERS] Failed to collect pending earnings: " + e);
            return { collected: [], totalCash: 0, totalToSupport: 0 };
        }
    }
