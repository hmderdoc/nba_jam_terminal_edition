...
(function() {
     ...
     * Wave 24: Adjusted for short LORB games (90 real seconds at 2x speed = ~26 total points)
     */
    function calculateTotal(team1Power, team2Power) {
        var config = (LORB.Config && LORB.Config.BETTING_TOTALS) || {
            basePerTeam: 13,      // ~13 points per team for short games
            powerScale: 1.5,      // Smaller power influence
            minTotal: 18,         // Minimum total
            maxTotal: 38          // Maximum total
        };
