...
// Load version info for main menu display
try {
    load(js.exec_dir + "lib/utils/version.js");
} catch (e) {
...
function mainMenu() {
    ...
    courtFrame.center("\1h\1y NBA JAM 2v2 \1n- Terminal Edition\r\n");
    
    // Show git commit hash on second line
    var commitHash = "unknown";
    if (typeof NBA_JAM !== "undefined" && NBA_JAM.Version && NBA_JAM.Version.getCommitHash) {
        commitHash = NBA_JAM.Version.getCommitHash();
    }
    courtFrame.center("\1n\1wbuild: " + commitHash + "\1n\r\n");
    courtFrame.center("\1h\1rBETA VERSION REPORT BUGS TO: \1wlarry.lagomorph@gmail.com\1n\r\n");
    ...
    while (true) {
        ...
        if (choice === null || choice === "quit" || choice === "Q") {
            ...
            courtFrame.gotoxy(1, 2);
            courtFrame.center("\1h\1y NBA JAM 2v2 \1n- Terminal Edition\r\n");
            var commitHash2 = "unknown";
            if (typeof NBA_JAM !== "undefined" && NBA_JAM.Version && NBA_JAM.Version.getCommitHash) {
                commitHash2 = NBA_JAM.Version.getCommitHash();
            }
            courtFrame.center("\1n\1wbuild: " + commitHash2 + "\1n\r\n");
            courtFrame.center("\1h\1rBETA VERSION REPORT BUGS TO: \1wlarry.lagomorph@gmail.com\1n\r\n");
            cycleFrame(courtFrame);
            lightbar.draw();
        }
...
function mainMenuFallback() {
    ...
    courtFrame.center("\r\n\r\n\r\n");
    courtFrame.center("\1h\1y NBA JAM 2v2 \1n- Terminal Edition\r\n");
    var commitHash3 = "unknown";
    if (typeof NBA_JAM !== "undefined" && NBA_JAM.Version && NBA_JAM.Version.getCommitHash) {
        commitHash3 = NBA_JAM.Version.getCommitHash();
    }
    courtFrame.center("\1n\1wbuild: " + commitHash3 + "\1n\r\n");
    courtFrame.center("\1h\1rBETA VERSION REPORT BUGS TO: \1wlarry.lagomorph@gmail.com\1n\r\n\r\n");
