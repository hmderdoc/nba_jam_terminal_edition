 ...
 */
function collectGameResults(redTeamKey, blueTeamKey, systems) {
    var stateManager = systems.stateManager;
    var score = stateManager.get('score');
    var teamAScore = score.teamA || 0;
    var teamBScore = score.teamB || 0;
    ...
    return {
        teamATeam: teamNames.teamA || redTeamKey,
        teamBTeam: teamNames.teamB || blueTeamKey,
