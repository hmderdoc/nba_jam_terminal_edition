...
function drawScore(systems) {
    ...
    var teamBTeamAbbr = (teamAbbrs && teamAbbrs.teamB) ? String(teamAbbrs.teamB).toUpperCase() : "TMB";
    var teamATeamAbbr = (teamAbbrs && teamAbbrs.teamA) ? String(teamAbbrs.teamA).toUpperCase() : "TMA";
