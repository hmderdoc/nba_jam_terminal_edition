...
function drawScore(systems) {
    ...
    var teamBTeamName = teamNames && teamNames.teamB ? teamNames.teamB.toUpperCase() : "BLUE";
    var teamATeamName = teamNames && teamNames.teamA ? teamNames.teamA.toUpperCase() : "RED";
    var teamAbbrs = stateManager.get('teamAbbrs');
    var teamBTeamAbbr = (teamAbbrs && teamAbbrs.teamB) ? String(teamAbbrs.teamB).toUpperCase() : "BLU";
    var teamATeamAbbr = (teamAbbrs && teamAbbrs.teamA) ? String(teamAbbrs.teamA).toUpperCase() : "RED";
