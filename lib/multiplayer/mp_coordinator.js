    ...
    this.applyInput = function (input) {
        ...
        if (key === ' ') {
            ...
            if (typeof applyMovementCommand === "function") {
                ...
                // Calculate where sprite would move
                if (key == KEY_LEFT) plannedX -= 1;
                else if (key == KEY_RIGHT) plannedX += 1;
                else if (key == KEY_UP) plannedY -= 1;
                else if (key == KEY_DOWN) plannedY += 1;
