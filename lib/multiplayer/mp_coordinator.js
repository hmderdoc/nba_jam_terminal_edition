...
function GameCoordinator(sessionId, client, serverConfig, systems) {
    ...
    this.serializeGameState = function () {
        ...
        // Include court redraw hint so clients know to force a redraw when coordinator requires it
        var courtNeedsRedrawFlag = !!stateManager.get('courtNeedsRedraw');
