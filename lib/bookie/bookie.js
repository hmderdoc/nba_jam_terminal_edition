...
function BettingSlip() {
    this.bets = [];
    this.startingBankroll = BETTING_DEFAULTS.defaultBankroll;
...
function showBettingInterface(matchupData) {
    ...
    var betAmount = BETTING_DEFAULTS.defaultWager;
    ...
    while (true) {
        ...
        console.putmsg(teamAColor + matchupData.teamATeam + "\1n");
        console.putmsg("  \1h\1wvs\1n  ");
        console.putmsg(teamBColor + matchupData.teamBTeam + "\1n\r\n\r\n");
        ...
        if (currentScreen === 'menu') {
            ...
            if (matchupData.sprites && matchupData.sprites.length === 4) {
                ...
                // Red team header
                console.putmsg(teamAColor + matchupData.teamATeam.substring(0, 35) + "\1n");
                for (var sp = 0; sp < (40 - matchupData.teamATeam.length); sp++) console.putmsg(" ");
                console.putmsg(teamBColor + matchupData.teamBTeam.substring(0, 35) + "\1n\r\n");

                // Red team player names
                var rp1Name = matchupData.teamAPlayers[0] ? matchupData.teamAPlayers[0].name.substring(0, 18) : "Player 1";
                var rp2Name = matchupData.teamAPlayers[1] ? matchupData.teamAPlayers[1].name.substring(0, 18) : "Player 2";
                var bp1Name = matchupData.teamBPlayers[0] ? matchupData.teamBPlayers[0].name.substring(0, 18) : "Player 1";
                var bp2Name = matchupData.teamBPlayers[1] ? matchupData.teamBPlayers[1].name.substring(0, 18) : "Player 2";

                console.putmsg(teamAColor + rp1Name + "\1n");
                for (var s1 = 0; s1 < (20 - rp1Name.length); s1++) console.putmsg(" ");
                console.putmsg(teamAColor + rp2Name + "\1n");
                for (var s2 = 0; s2 < (20 - rp2Name.length); s2++) console.putmsg(" ");
                console.putmsg(teamBColor + bp1Name + "\1n");
                for (var s3 = 0; s3 < (20 - bp1Name.length); s3++) console.putmsg(" ");
                console.putmsg(teamBColor + bp2Name + "\1n\r\n");
                ...
                var spriteTeamKeys = ['teamA', 'teamA', 'teamB', 'teamB'];
                var xPos = 0;
            ...
            if (spread.favorite === "teamA") {
                console.putmsg("   " + teamAColor + matchupData.teamATeam + " -" + spread.spread + "\1n \1k(must win by more than " + spread.spread + ")\1n\r\n");
                console.putmsg("   " + teamBColor + matchupData.teamBTeam + " +" + spread.spread + "\1n \1k(must lose by less than " + spread.spread + " or win)\1n\r\n\r\n");
            } else {
                console.putmsg("   " + teamBColor + matchupData.teamBTeam + " -" + spread.spread + "\1n \1k(must win by more than " + spread.spread + ")\1n\r\n");
                console.putmsg("   " + teamAColor + matchupData.teamATeam + " +" + spread.spread + "\1n \1k(must lose by less than " + spread.spread + " or win)\1n\r\n\r\n");
            }
...
function handleBettingSubScreen(screen, matchupData, defaultAmount, slip) {
    ...
    if (screen === 'moneyline') {
        ...
        console.putmsg("\1h\1g1\1n. " + teamAColor + matchupData.teamATeam + "\1n " + formatOdds(matchupData.odds.teamAOdds) + "\r\n");
        console.putmsg("\1h\1g2\1n. " + teamBColor + matchupData.teamBTeam + "\1n " + formatOdds(matchupData.odds.teamBOdds) + "\r\n\r\n");
        console.putmsg("\1h\1kQ\1n. Back\r\n\r\n");
        console.putmsg("Pick: ");

        var key = console.getkey();
        if (key === '1') {
            return { type: 'moneyline', selection: 'teamA', odds: matchupData.odds.teamAOdds, risk: BETTING_DEFAULTS.defaultWager };
        } else if (key === '2') {
            return { type: 'moneyline', selection: 'teamB', odds: matchupData.odds.teamBOdds, risk: BETTING_DEFAULTS.defaultWager };
        }
        ...
        var spread = matchupData.spread;
        if (spread.favorite === "teamA") {
            console.putmsg("\1h\1g1\1n. " + teamAColor + matchupData.teamATeam + " -" + spread.spread + "\1n (-110)\r\n");
            console.putmsg("   \1k(must win by more than " + spread.spread + " points)\1n\r\n\r\n");
            console.putmsg("\1h\1g2\1n. " + teamBColor + matchupData.teamBTeam + " +" + spread.spread + "\1n (-110)\r\n");
            console.putmsg("   \1k(must lose by less than " + spread.spread + " or win)\1n\r\n\r\n");
        } else {
            console.putmsg("\1h\1g1\1n. " + teamBColor + matchupData.teamBTeam + " -" + spread.spread + "\1n (-110)\r\n");
            console.putmsg("   \1k(must win by more than " + spread.spread + " points)\1n\r\n\r\n");
            console.putmsg("\1h\1g2\1n. " + teamAColor + matchupData.teamATeam + " +" + spread.spread + "\1n (-110)\r\n");
            console.putmsg("   \1k(must lose by less than " + spread.spread + " or win)\1n\r\n\r\n");
        }
        console.putmsg("\1h\1kQ\1n. Back\r\n\r\n");
        console.putmsg("Pick: ");
        ...
        if (keySpread === '1') {
            ...
            return { type: 'spread', selection: { team: team1, spread: spread.spread }, odds: -110, risk: BETTING_DEFAULTS.defaultWager };
        } else if (keySpread === '2') {
            var team2 = spread.favorite === "teamA" ? "teamB" : "teamA";
            return { type: 'spread', selection: { team: team2, spread: spread.spread }, odds: -110, risk: BETTING_DEFAULTS.defaultWager };
        }
        ...
        if (keyTotal === '1') {
            return { type: 'total', selection: 'over', odds: matchupData.total, risk: BETTING_DEFAULTS.defaultWager };
        } else if (keyTotal === '2') {
            return { type: 'total', selection: 'under', odds: matchupData.total, risk: BETTING_DEFAULTS.defaultWager };
        }
        ...
        if (keyUpper === 'Q') {
            ...
            for (var statKey in selectedBets) {
                if (selectedBets.hasOwnProperty(statKey)) {
                    ...
                    slip.addBet('leader', { stat: statKey, player: bet.name }, bet.odds, BETTING_DEFAULTS.defaultWager);
                    addedAny = true;
                }
            }
...
function showBettingResults(slip, gameResults) {
    ...
    console.putmsg("  \1h\1r" + gameResults.teamATeam + ": " + gameResults.teamAScore + "\1n\r\n");
    console.putmsg("  \1h\1c" + gameResults.teamBTeam + ": " + gameResults.teamBScore + "\1n\r\n");
