...
function handleBettingSubScreen(screen, matchupData, defaultAmount, slip) {
    ...
    if (screen === 'moneyline') {
        ...
        if (key === '1') {
            return { type: 'moneyline', selection: 'teamA', odds: matchupData.odds.teamAOdds, risk: 100 };
        } else if (key === '2') {
            return { type: 'moneyline', selection: 'teamB', odds: matchupData.odds.teamBOdds, risk: 100 };
        }
