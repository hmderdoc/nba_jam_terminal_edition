...
var MP_CONSTANTS = {
    ...
    // Multiplayer screen sync timeouts (how long to wait for all players before forcing proceed)
    SCREEN_TIMEOUTS: {
        SPLASH_MS: 10000,        // 10 seconds for splash/title screen
        MATCHUP_MS: 15000,       // 15 seconds for matchup preview
        HALFTIME_MS: 20000,      // 20 seconds for halftime (was 60s, reduced for faster testing)
        GAME_OVER_MS: 120000     // 2 minutes for game over/results
    }
};
