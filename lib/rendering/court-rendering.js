...
function drawCourt(systems) {
    ...
    // Ensure court frame is on top of console but below sprites
    if (courtFrame.top) {
        courtFrame.top();
    }
    ...
    if (typeof debugLog === "function") {
        debugLog("[drawCourt] COMPLETE: Court background drawn and frame cycled");
    }
}
...
function updateSpriteRendering(systems) {
    ...
    // Wave 23D: Also cycle court frame to ensure sprites are visible
