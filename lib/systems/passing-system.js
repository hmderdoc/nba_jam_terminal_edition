    ...
    function _handlePassComplete(stateData) {
        ...
        if (stateData.intercepted && stateData.receiver) {
            ...
            try {
                ...
                f.writeln("  Receiver position: (" + stateData.receiver.x + "," + stateData.receiver.y + ")");
                f.writeln("  Passer name: " + (stateData.passer && stateData.passer.playerData ? stateData.passer.playerData.name : "unknown"));
                f.writeln("  Passer position: (" + stateData.passer.x + "," + stateData.passer.y + ")");
                f.close();
            } catch (e) { }
