 ...
 */
    ...
    function _handlePassComplete(stateData) {
        // Simple console output to verify callback is called
        console.print("\r\n[PASS CALLBACK] Fired\r\n");

        // Clear rebound state
        deps.state.set('reboundActive', false, 'pass_complete'); if (stateData.intercepted && stateData.receiver) {
            // INTERCEPTION
            ...
            // SUCCESSFUL PASS
            console.print("\r\n[PASS CALLBACK] Setting ballCarrier\r\n");
            deps.state.set('ballCarrier', stateData.receiver, 'pass_complete');
            console.print("\r\n[PASS CALLBACK] ballCarrier set\r\n");
