...
function createPossessionSystem(deps) {
    ...
    function setupInbound(scoringTeam, reason) {
        ...
        var useOverride = override && override.inboundTeam === inboundTeam;
        if (useOverride) {
        ...
        if (useOverride) {
            ...
            state.set("secondHalfPositioningOverride", override, "second_half_positioning_consumed");
            if (inboundReason !== "second_half_start") {
                state.set("secondHalfPositioningOverride", null, "second_half_positioning_cleared");
            }
        }
