 ...
 * @param {Array} team - Array of player sprites (NOT a team name string)
 * @returns {Object|null} Closest player sprite or null
 */
...
/**
 * Get the opposing team's player array for a given team name
 * @param {string} teamName - "teamA" or "teamB"
 * @returns {Array} Array of opposing team's player sprites
 */
function getOpposingTeam(teamName) {
    var opposingTeamName = teamName === "teamA" ? "teamB" : "teamA";
    return getTeamSprites(opposingTeamName);
}
