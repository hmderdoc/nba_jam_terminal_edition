...
// Only add drawBorder if it doesn't already exist (avoid conflicts with shell/other doors)
if (typeof Frame !== 'undefined' && typeof Frame.prototype.drawBorder === 'undefined') {
    log(LOG_INFO, "NBA JAM: Adding Frame.prototype.drawBorder");
...
} // End Frame.prototype.drawBorder conditional
