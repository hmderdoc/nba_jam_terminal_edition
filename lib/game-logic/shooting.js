...
function attemptShot() {
    ...
    if (made) {
        ...
        var scoringSprites = scoringTeamKey === "teamA" ? [teamAPlayer1, teamAPlayer2] : [teamBPlayer1, teamBPlayer2];
        ...
        var inboundSprites = inboundTeamKey === "teamA" ? [teamAPlayer1, teamAPlayer2] : [teamBPlayer1, teamBPlayer2];
