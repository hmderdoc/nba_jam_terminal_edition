 ...
 * - Player utilities (getPlayerGlobalId, getRedTeam, getBlueTeam, getEffectiveAttribute)
...
function checkPassInterception(passer, receiver, targetOverride) {
    ...
    var defenders = passerTeam === "teamA" ? getBlueTeam() : getRedTeam();
...
function isDefenderPlayingTooTight(ballHandler, opponentTeam) {
    ...
    var opponents = opponentTeam === "teamA" ? getRedTeam() : getBlueTeam();
