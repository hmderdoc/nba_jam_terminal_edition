...
function executePass(passer, receiver, leadTarget) {
    ...
    if (interceptor) {
        ...
        stateManager.set("consecutivePoints", consecutivePoints, "pass_intercepted");
    ...
    if (ballCarrier) {
        stateManager.set("ballHandlerLastX", ballCarrier.x, "pass_tracking");
        stateManager.set("ballHandlerLastY", ballCarrier.y, "pass_tracking");
        stateManager.set("ballHandlerFrontcourtStartX", ballCarrier.x, "pass_tracking");
        stateManager.set("ballHandlerProgressOwner", ballCarrier, "pass_tracking");
    }
