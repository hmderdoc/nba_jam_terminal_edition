...
function createDefaultGameState() {
    ...
    timeRemaining: 360, // 6-minute halves (default game length)
    totalGameTime: 360, // 360 seconds = 6 minutes
...
function advancePhaseTimer(systems) {
    ...
    if (typeof debugLog === "function" && (phaseObj.frameCounter % 5 === 0 || isComplete)) {
