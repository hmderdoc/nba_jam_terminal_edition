...
function Player(name, jersey, attributes, sprite, shortNick) {
    ...
    this.shoveRecoveryFrames = 0; // Frames victim is stunned after being shoved
    this.turboDisabledFrames = 0; // Frames victim cannot use turbo after shove recovery ends
