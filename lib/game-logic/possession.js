 ...
 */
function prepareSecondHalfPositions(inboundTeam, systems) {
    var stateManager = systems.stateManager;
    ...
    stateManager.set("inboundPositioning", positioning, "second_half_positioning");
    ...
    stateManager.set("inboundAlternateIndex", inboundAltIndex, "second_half_positioning");

    stateManager.set("secondHalfPositioningOverride", {
        inboundTeam: inboundTeam,
        inbounder: inbounderSprite,
        receiver: receiverSprite,
        reason: "second_half_start",
        consumed: false
    }, "second_half_positioning");

    if (typeof debugLog === "function") {
        debugLog("[SECOND HALF] Prepared positioning for " + inboundTeam + " (inbounder=" +
