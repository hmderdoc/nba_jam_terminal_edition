...
function animateDunk(player, dunkInfo, targetX, targetY, made, systems) {
    ...
    stateManager.set("shotStartY", player.y, "dunk_tracking"); var playerData = player.playerData || {};
...
function executeShot(shooter, shotStartX, shotStartY, targetX, targetY, systems) {
    ...
    if (made && !blocked) {
        ...
        if (mpCoordinator && mpCoordinator.isCoordinator) {
            ...
            gameState.reboundScramble.reboundX = reboundX;
            gameState.reboundScramble.reboundY = reboundY;
