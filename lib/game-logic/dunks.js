...
function executeShot(shooter, shotStartX, shotStartY, targetX, targetY) {
    ...
    if (made && !blocked) {
        ...
        // Refill turbo
        var scoringSprites = shooterTeam === "teamA" ? [teamAPlayer1, teamAPlayer2] : [teamBPlayer1, teamBPlayer2];
        ...
        var inboundSprites = inboundTeam === "teamA" ? [teamAPlayer1, teamAPlayer2] : [teamBPlayer1, teamBPlayer2];
