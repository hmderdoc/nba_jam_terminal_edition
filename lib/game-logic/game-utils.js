...
/**
 * Force a player to pick up their dribble (lose ability to dribble again)
 * @param {Sprite} player - Player who is picking up the dribble
 * @param {string} reason - Reason for pickup ("user", "auto", etc.)
 */
