...
function recordStatDelta(player, statKey, amount, systems, options) {
    ...
    if (enableTrail && systems && systems.statTrailSystem && typeof systems.statTrailSystem.queueStatTrail === "function") {
        ...
        var teamKey = opts.teamKey || (typeof getPlayerTeamName === "function" ? getPlayerTeamName(player) : null);
        ...
        if (text) {
            ...
            // WAVE 24: Emit animation hint for multiplayer sync
            // Non-coordinators will receive this and display their own stat trail
            if (typeof mpCoordinator !== "undefined" && mpCoordinator && 
                mpCoordinator.isCoordinator && mpCoordinator.animationHintTracker &&
                typeof mpCoordinator.animationHintTracker.recordEvent === "function") {
                var targetId = (typeof getPlayerGlobalId === "function") ? getPlayerGlobalId(player) : null;
                if (targetId) {
                    mpCoordinator.animationHintTracker.recordEvent('stat_trail', {
                        targetId: targetId,
                        text: text,
                        teamKey: teamKey,
                        statType: statType,
