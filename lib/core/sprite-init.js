...
function initSprites(teamATeamName, teamBTeamName, redPlayerIndices, bluePlayerIndices, allCPUMode, systems) {
    ...
    stateManager.set("ballCarrier", teamAPlayer1, "init_sprites");
    stateManager.set("currentTeam", "teamA", "init_sprites");
    ...
    stateManager.set("firstHalfStartTeam", "teamA", "init_sprites");
