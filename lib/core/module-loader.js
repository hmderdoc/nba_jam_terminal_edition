...
function loadGameModules() {
    ...
    try {
        ...
        // Difficulty scaling for LORB courts and boss battles
        load(js.exec_dir + "lib/config/difficulty-scaling.js");

        // Utilities
        load(js.exec_dir + "lib/utils/helpers.js");

        // JSONClient singleton factory (must load before multiplayer/LORB)
        load(js.exec_dir + "lib/utils/json-client-factory.js");
        ...
        load(js.exec_dir + "lib/systems/rubber-banding-system.js");
        load(js.exec_dir + "lib/systems/buff-system.js");

        // Rendering
        load(js.exec_dir + "lib/rendering/frame-manager.js");
        ...
        load(js.exec_dir + "lib/game-logic/jump-ball-system.js");
        load(js.exec_dir + "lib/game-logic/overtime.js");
        ...
        load(js.exec_dir + "lib/game-logic/external-game.js");
        ...
        load(js.exec_dir + "lib/ui/overtime-intro.js");
        ...
        load(js.exec_dir + "lib/animation/stat-trail-system.js");
        load(js.exec_dir + "lib/animation/animation-hint-effects.js");
        ...
        try {
            ...
            load(js.exec_dir + "lib/multiplayer/mp_lobby_v2.js");
