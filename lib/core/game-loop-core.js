...
function runGameFrame(systems, config) {
    ...
    if (authorityActive) {
        ...
        var skipPhases = [PHASE_SHOT_SCORED, PHASE_INBOUND_SETUP, PHASE_SHOT_MISSED, PHASE_REBOUND_SCRAMBLE, PHASE_JUMP_BALL, PHASE_OVERTIME_INTRO];
    ...
    if (authorityActive) {
        ...
        var phaseType = currentPhase ? (currentPhase.current || currentPhase.name || "NORMAL") : "NORMAL";
        var clocksShouldRun = (phaseType !== PHASE_INBOUND_SETUP && phaseType !== PHASE_SHOT_SCORED && phaseType !== PHASE_JUMP_BALL && phaseType !== PHASE_OVERTIME_INTRO);
    ...
    if (authorityActive) {
        ...
        var skipAIPhases = [PHASE_SHOT_SCORED, PHASE_INBOUND_SETUP, PHASE_SHOT_MISSED, PHASE_JUMP_BALL, PHASE_OVERTIME_INTRO];
        var shouldRunAI = skipAIPhases.indexOf(phaseName) === -1 && !overtimeIntroActive;
